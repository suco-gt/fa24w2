...
class Instruction:
    def __init__(self, opcode, count, dest_reg=0, src_reg1=0, src_reg2=0):
        ...
        self.dest_reg = dest_reg                               # Destination register (e.g., "R1", "R2", etc., or -1 if not applicable)
        self.src_reg1 = src_reg1                               # Source register 1 (e.g., "R1", "R2", etc., or -1 if not applicable)
